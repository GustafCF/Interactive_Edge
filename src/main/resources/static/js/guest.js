class GuestManager {
    ...
    initEventListeners() {
        ...
        document.querySelectorAll('#guestName, #guestRg, #guestPhone, #guestEmail').forEach(input => {
    ...
    // 🆕 Método para desabilitar/habilitar o botão e mostrar loading
    setSavingState(saving) {
        ...
        if (saveBtn) {
            if (saving) {
                ...
                saveBtn.innerHTML = '<div class="loading loading-small"></div> Salvando...';
            } else {
                saveBtn.disabled = false;
                saveBtn.innerHTML = this.editingGuestId 
                    ? '<i class="fas fa-save"></i> Atualizar Hóspede'
                    : '<i class="fas fa-save"></i> Salvar Hóspede';
            }
        }
    }
    ...
    clearForm() {
        ...
        // O texto do botão será restaurado pelo setSavingState(false) se necessário, mas aqui forçamos
        const saveBtn = document.getElementById('saveGuestBtn');
        if (saveBtn) {
            saveBtn.innerHTML = '<i class="fas fa-save"></i> Salvar Hóspede';
            saveBtn.disabled = false;
        }
        ...
        this.clearErrors();
        this.isSaving = false; // Garantir que o flag seja resetado
    }
