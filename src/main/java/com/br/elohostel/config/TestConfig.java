...
public class TestConfig implements CommandLineRunner {
    ...
    public TestConfig(GuestRepository idRepo, RoomRepository roomRepo, UserRepository userRepo, BCryptPasswordEncoder passwordEncode, ReserveRepository reserveRepo, BedRepository bedRepo, RoleRepository roleRepo, TenantRepository tenantRepo, PlanRepository planRepo) {
        this.idRepo = idRepo;
