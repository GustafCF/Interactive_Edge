...
public class AirbnbConnectionController {
    ...
    public ResponseEntity<Map<String, Object>> connectAirbnb(
        ...
        try {
            ...
            syncConfig.setIcalUrl(request.icalUrl());
            syncConfig.setPropertyId(request.propertyId());
            syncConfig.setIsActive(true);
            syncConfig.setLastSync(LocalDateTime.now());
            
            airbnbSyncRepository.save(syncConfig);
    ...
    public ResponseEntity<Map<String, Object>> updateConnection(
        ...
        Optional<AirbnbSync> existingSync = airbnbSyncRepository.findByIdAndTenant_TenantKey(id, tenantKey);
